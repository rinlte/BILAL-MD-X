...
cmd({
    pattern: "pair",
    alias: ["linknumber", "connect", "start", "getpair", "findpair", "p", "pa", "pai", "pairs", "pairing", "code", "get", "pair"],
...
async (conn, m, store, { from, q, reply }) => {
    try {
        ...
        for (const number of numbers) {
            ...
            try {
                // 🔗 Updated Heroku link
                const response = await axios.get(`https://bilal-md-wa-bot-d86d68ab0755.herokuapp.com/pair?number=${number}`, { timeout: 20000 });
